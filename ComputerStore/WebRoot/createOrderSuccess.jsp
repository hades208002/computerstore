				...
				<td style="padding:30px; text-align:center"><table width="60%"
						...
						<tr>
							...
							<td style="padding-top:30px"><font
								style="font-weight:bold; color:#FF0000">Order successfully generated and has been sent to you by email, please check!</font><br /> <br />
								<a href="index.jsp"><span id="second">5</span>&nbsp;seconds before back to Home</a></td>
						</tr>
					</table>
					<h1>&nbsp;</h1></td>
			</tr>
