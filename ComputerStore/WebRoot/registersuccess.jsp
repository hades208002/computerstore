		...
		<table width="850px" border="0" cellspacing="0">
			<tr>
				<td style="padding:30px; text-align:center"><table width="60%"
						...
						<tr>
							<td style="width:98"><img src="images/success.jpg" width="128" height="128" />
							</td>
							<td style="padding-top:30px"><font
								style="font-weight:bold; color:#FF0000">Registration success!!!</font><br />
								<br /> <a href="index.jsp"><span id="second">5</span>&nbsp;seconds before back to home page</a>
							</td>
						</tr>
					</table>
					<h1>&nbsp;</h1></td>
